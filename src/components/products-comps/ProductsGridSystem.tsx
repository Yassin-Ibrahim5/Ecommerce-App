...
export default function ProductsGridSystem({products}: { products: { data: Product[], } }) {
    return (
        <div className={`w-full md:w-[85%] mt-10 md:mt-15 mx-auto`}>
            <h2 className="text-3xl md:text-4xl mb-5 text-start font-bold uppercase font-[Poppins] text-[#222222] px-4 md:px-10">Products
                Overview</h2>
            <Tabs className={`font-[Poppins] transition-all duration-400`} defaultValue={"all-products"}>
                ...
                <TabsContent value={"all-products"} className={`transition-all duration-400 p-4 md:p-10`}>
